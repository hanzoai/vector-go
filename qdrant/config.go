...
const (
	...
	// Hanzo ZAP-protocol default port (used by qdrant/zap_client.go).
...
// getZapAddr returns the Hanzo ZAP-protocol address string.
// ZAP is a separate wire protocol port distinct from the gRPC port.
